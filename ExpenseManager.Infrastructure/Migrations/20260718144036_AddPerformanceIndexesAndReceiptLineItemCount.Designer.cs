...
namespace ExpenseManager.Infrastructure.Migrations
{
    ...
    [Migration("20260718144036_AddPerformanceIndexesAndReceiptLineItemCount")]
    partial class AddPerformanceIndexesAndReceiptLineItemCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseManager.Domain.Entities.Receipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ConfirmedImportMode")
                        .HasMaxLength(20)
            ...
            modelBuilder.Entity("ExpenseManager.Domain.Entities.Expense", b =>
                {
                    ...
                    b.HasOne("ExpenseManager.Domain.Entities.Receipt", "Receipt")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("ExpenseManager.Domain.Entities.Receipt", b =>
                {
                    b.HasOne("ExpenseManager.Domain.Entities.Category", "SuggestedCategory")
                        .WithMany()
